...
万物板是一个开源IoT平台，用于数据采集，处理，可视化和设备管理。

<img src="./img/logo.png?raw=true" width="100" height="100">

## 官方文档

万物板官方网站请访问 [thingsboard.io](https://thingsboard.io/docs).

## IoT应用案例

[**智能电表**](https://thingsboard.io/smart-metering/)
...
[**规则引擎**](https://thingsboard.io/docs/user-guide/rule-engine-2-0/re-getting-started/)
...
[**智慧能源**](https://thingsboard.io/smart-energy/)
...
[**智慧农业**](https://thingsboard.io/smart-farming/)
...
[**车队追踪**](https://thingsboard.io/fleet-tracking/)
...
收集并可视化你的物联网数据 [指导手册](https://thingsboard.io/docs/getting-started-guides/helloworld/).

## 支持（英文）

 - [社区聊天室内](https://gitter.im/thingsboard/chat)
 - [Q&A 论坛](https://groups.google.com/forum/#!forum/thingsboard)
